...
//        OrganizationWithUId organizationWithUId = new OrganizationWithUId(new Organization("removers",new Coordinates(12, new Float(54)),123,"",2, OrganizationType.PUBLIC,new Address("suck",new Location(41,new Long(123),53))),"Nekit", 69);
